...
<h3>№1 </h3><br>
<br>
Вас пригласили настроить мониторинг на проект. На онбординге вам рассказали, что проект представляет из себя платформу для вычислений с выдачей текстовых отчетов, которые сохраняются на диск. Взаимодействие с платформой осуществляется по протоколу http. Также вам отметили, что вычисления загружают ЦПУ. <br>
...
<h3>№3 </h3><br>
<br>
Вашей DevOps команде в этом году не выделили финансирование на построение системы сбора логов. Разработчики в свою очередь хотят видеть все ошибки, которые выдают их приложения. <br>
...
<h3>№4 </h3><br>
<br>
Вы, как опытный SRE, сделали мониторинг, куда вывели отображения выполнения SLA=99% по http кодам ответов. Вычисляете этот параметр по следующей формуле: summ_2xx_requests/summ_all_requests. <br>
...
Для того чтобы получить точное значение требуется пересмотреть выражение и добавить в вычисления остальные возможные коды ответов, например (summ_2xx_requests+summ_3xx_requests)/summ_all_requests <br>
...
|TICK|Да|Да|Да|
|Zabbix|Да|Да|Да|
|VictoriaMetrics|Да|Да|Да, поддерживает push через механизм, аналогичный Pushgateway|
|Nagios|Да|Нет|Да, но через плагины|

<br><br>

<h2>Задача 2</h2><br>
<br>
 Склонируйте себе репозиторий и запустите TICK-стэк, используя технологии docker и docker-compose. <br>
...
<h2>Задача 3</h2><br>
<br>
Перейдите в веб-интерфейс Chronograf (http://localhost:8888) и откройте вкладку Data explorer.<br>
...
![web](https://github.com/IvanChet-4/Dev/blob/main/images/Homework%205-2/1.png)

![explore](https://github.com/IvanChet-4/Dev/blob/main/images/Homework%205-2/2.png)

![dashbord](https://github.com/IvanChet-4/Dev/blob/main/images/Homework%205-2/3.png)

<br><br>

<h2>Задача 4</h2><br>
<br>
Изучите список telegraf inputs. Добавьте в конфигурацию telegraf следующий плагин - docker:<br>
...
Дополнительно вам может потребоваться донастройка контейнера telegraf в docker-compose.yml дополнительного volume и режима privileged:<br>
...
<br>
Факультативно можете изучить какие метрики собирает telegraf после выполнения данного задания.<br>

![docker](https://github.com/IvanChet-4/Dev/blob/main/images/Homework%205-2/4.png)
